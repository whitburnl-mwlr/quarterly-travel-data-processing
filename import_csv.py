...
def main(orca_filename, airports_filename, bookingtype_filename, faretype_filename, co2_filename, filter_refunds=True):
...
if __name__ == "__main__":
    main("Input/orca_data.csv", "Input/airports.csv", "Input/booking_types.csv", "Input/fare_types.csv", "Input/co2.csv")
